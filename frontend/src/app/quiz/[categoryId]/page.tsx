...
export default function TopicSelectionPage({ params }: { params: Promise<{ categoryId: string }> }) {
  ...
  return (
    <div className="container mx-auto p-6 pt-24 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-zinc-400">Choose a topic to start your quiz</p>
      </div>
      ...
      {topics.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {topics.map((topic, idx) => (
            ...
            >
              <Link href={`/quiz/${categoryId}/${topic.id}`}>
